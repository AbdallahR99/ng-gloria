...
export class GServicesComponent {
  ...
  upcomingFeatures = signal([
    {
      ...
      description: 'Personalized fragrance creation tailored to your preferences',
      icon: 'sparkles',
      color: 'accent'
    },
    {
  ...
  isSubscribeButtonDisabled = computed(() => 
    !this.email() || !this.isValidEmail() || this.subscriptionStatus() === 'loading'
  );
